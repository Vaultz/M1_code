...
void* philo_thread(void* arg) {
    ...
    for(i = 0; i < EAT_TIMES; i++) {
        ...
        printf("phylo %d a reçu la fourchette %d\n", p.num, RIGHT(p.num));
        printf("phylo %d attend la fourchette %d\n", p.num, LEFT(p.num));
...
$ gcc exo1_philo.c -o philo -pthread
$ ./philo
phylo 0 attend la fourchette 1
phylo 1 attend la fourchette 2
phylo 1 attend la fourchette 1
phylo 2 attend la fourchette 0
phylo 2 attend la fourchette 2
phylo 0 attend la fourchette 0

L'interblocage se produit : tous les philosophes (sémaphores) attendent leur tour et se bloquent.
*/
